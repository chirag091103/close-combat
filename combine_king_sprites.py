...
def combine_king_sprites():
    ...
    sprite_files = [
        ...
        ("Attack2.png", 4),   # attack2 - 4 frames
        ("Take Hit.png", 4),  # hit - 4 frames
        ("Death.png", 6)      # death - 6 frames
    ]
    
    base_path = "assets/images/Medieval King Pack 2/Sprites"
    ...
    pygame.image.save(combined, os.path.join(base_path, "king.png"))
    print(f"\nCreated sprite sheet: {max_frames * frame_size}x{len(sprite_files) * frame_size}")
    pygame.quit()

if __name__ == "__main__":
    combine_king_sprites() 